...
const jp: PartialLocaleType = {
  ...
  Chat: {
    ...
    Actions: {
      ...
      Delete: "削除",
      Edit: "編集",
      Shot2code: "スクリーンショットから HTML コードへ",
    },
    Rename: "チャットの名前を変更",
    Typing: "入力中…",
  ...
  Store: {
    ...
    BotHello: `# AI Guoguo へようこそ! \r\n- このサイトには、dall-e 描画と gpt-4-vision 画像認識が実装されています。 直下で機種を切り替えてご利用いただけます。 \r\n- 画像から HTML へ: [スクリーンショット変換](https://shot2code.aiguoguo199.com/ "スクリーンショット変換") \r\n- API キーの購入: [AI Guoguo ストア](https://plati.market/seller/ai-guo-guo/1185183/ "AI Guoguo ストア") \r\n- お問い合わせ: TG グループ: [aiguoguo](https://t.me/aichat199 "aiguoguo") \r\n- 使用方法
    [![説明書](/ennavigation.png)](/ennavigation.png)`,
