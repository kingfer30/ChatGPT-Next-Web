...
const ru: PartialLocaleType = {
  ...
  Chat: {
    ...
    IsContext: "Слова подсказки по умолчанию",
    ImgInput:
      "Нажмите кнопку справа, чтобы загрузить файл изображения, или введите ссылку на изображение (несколько разрывов строк или пробелов), например: https://test.com/1.jpg https://test.com/2.jpg",
  },
  Export: {
    Title: "Все сообщения",
    Copy: "Копировать все",
